...
export const ListOffersResponse = zod.object({
    ...
    data_multiple: zod.array(zod.object({
        id: zod.string(),
        name: zod.string(),
        data: zod.string().nullish(),
        minutes: zod.string().nullish(),
...
export const InitiatePaymentBody = zod.object({
    ...
    recipientPhone: zod
        .string()
        .nullish()
        .describe("Recipient phone number — who receives the bundle (if different from payer)"),
